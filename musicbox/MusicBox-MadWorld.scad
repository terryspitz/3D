...
GENERATE_CRANK=0; // [1:yes, 0:no]
// Should the Pulley for the Crank be generated?
GENERATE_PULLEY=0; // [1:yes, 0:no]

// this text will0be put on top of the music cylinder
...
//You can use the output of the generator for this field: http://www.wizards23.net/projects/musicbox/musicbox.html
//Music box generator
//Enter your melody here
//Ab4
//C5
//G4 C4 Ab3
//Ab4
...
pinNrX = 10;
pinNrY = 32;
//teethNotes="F 3Ab3Bb3C 4D 4Eb4F 4G 4Ab4C 5";
teethNotes="F 2Ab2Bb2C 3D 3Eb3F 3G 3Ab3C 4";
pins="";
...
module MusicBox()
{
	...
	for (x = [0:pinNrX-1])
	{
		let(ll = TeethLen(x))
		{
			...
			{
				// teeth holder
				let (leftAdd = (x == 0) ? gearBoxW : 0, rightAdd = (x == pinNrX-1) ? wall/2+gear_gap : 0)
				{
				...
				// teeth
				translate([-teethHolderW/2, teethGap-2, 0])
				color([0,1,0])cube([maxTeethL+teethHolderW/2, 1+teethW, teethH]);
			}
		}
	}
